...
class DiazoThemeTest(BaseTemplateTest):
    ...
    def test_template(self):
        ...
        expected = [
            ...
            p_src_pkg + '/profiles/testfixture',
            p_src_pkg + '/profiles/testfixture/metadata.xml',
            p_src_pkg + '/profiles/testfixture/portlets.xml',
            ...
            p_src_pkg + '/theme',
            p_src_pkg + '/theme/assets',
            p_src_pkg + '/theme/assets/css',
            p_src_pkg + '/theme/assets/css/README',
            p_src_pkg + '/theme/assets/css/theme.css',
            p_src_pkg + '/theme/assets/img',
            p_src_pkg + '/theme/assets/img/README',
            p_src_pkg + '/theme/assets/js',
            p_src_pkg + '/theme/assets/js/README',
            p_src_pkg + '/theme/assets/js/theme.js',
            p_src_pkg + '/theme/assets/libraries',
            p_src_pkg + '/theme/assets/libraries/README',
            p_src_pkg + '/theme/index.html',
            p_src_pkg + '/theme/install',
            p_src_pkg + '/theme/install/registry.xml',
            p_src_pkg + '/theme/manifest.cfg',
            p_src_pkg + '/theme/package.json',
            p_src_pkg + '/theme/preview.png',
            p_src_pkg + '/theme/rules',
            p_src_pkg + '/theme/rules/content.xml',
            p_src_pkg + '/theme/rules/core.xml',
            p_src_pkg + '/theme/rules/footer.xml',
            p_src_pkg + '/theme/rules/header.xml',
            p_src_pkg + '/theme/rules/transformations.xml',
            p_src_pkg + '/theme/rules.xml',
            p_src_pkg + '/theme/uninstall',
            p_src_pkg + '/theme/uninstall/registry.xml',
            ...
            p_src_pkg + '/upgrades.py',
            p_src_pkg + '/upgrades.zcml',
        ]
